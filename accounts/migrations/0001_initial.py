    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_postal', models.IntegerField(verbose_name='Postal Code')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='accounts.region', verbose_name='Region')),
            ],
            options={
                'verbose_name': 'State',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='profiles', to='accounts.city', verbose_name='City')),
        ...
        migrations.AddField(
            model_name='city',
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='cities', to='accounts.state', verbose_name='State'),
        ),
    ]
